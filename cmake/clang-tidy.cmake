# clang-tidy.cmake - Add a target to run clang-tidy on all C/C++ files in the
# project
find_program(CLANG_TIDY_BIN clang-tidy)

file(
  GLOB_RECURSE
  ALL_CLANG_TIDY_FILES
...
if(CLANG_TIDY_BIN)
  ...
  message(
    WARNING
      "clang-tidy not found! Please install it to enable the run-clang-tidy target."
  )
endif()
